                                                              ...
                                                              children: [
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                              ...
                                                                              builder: (context) => AlertDialog(
                                                                                    content: Row(
                                                                                      children: [
                                                                                        ...
                                                                                        Container(
                                                                                          width: w * 0.5,
                                                                                          child: Text(snapshot.data["data"][position]["task"] != null ? snapshot.data["data"][position]["task"].toString() : "", maxLines: 8, style: const TextStyle(color: Colors.black54)),
                                                                                        ),
                                                                                      ],
                                                                                    ),
                                                                                  ));
                                                                    ...
                                                                    snapshot.data["data"][position]["task_img"] !=
                                                                            "N/A"
                                                                        ? Expanded(
                                                                            flex:
                                                                                1,
                                                                            child:
                                                                              ...
                                                                              onTap: () {
                                                                                Navigator.push(
                                                                                    ...
                                                                                    MaterialPageRoute(
                                                                                        builder: (c) => Taskimg(
                                                                                              img: snapshot.data["data"][position]["task_img"],
                                                                                            )));
                                                                              },
                                                                              child: Container(
                                                                                width: 30,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          snapshot.data["data"][position]["assigned_date"] +
                                                                              "@" +
                                                                              snapshot.data["data"][position]["assigned_time"],
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            color: snapshot.data["data"][position]["priority"] == "High"
                                                                                ? Colors.red
                                                                                : snapshot.data["data"][position]["priority"] == "Medium"
                                                                                    ? Colors.blue
                                                                                    : Colors.green,
                                                                            borderRadius:
                                                                ...
                                                                decoration:
                                                                  ...
                                                                  color: snapshot.data["data"][position]
                                                                      ...
                                                                      : snapshot.data["data"][position]["status"] ==
                                                                          ...
                                                                          ? Color(
                                                                              0xFFedc791)
                                                                          : snapshot.data["data"][position]["status"] == "Rejected"
                                                                              ? Color(0xFFed9c91)
                                                                              : Colors.grey,
                                                                ),
                                                                alignment:
                                                                                          ...
                                                                                          content: Container(
                                                                                            ...
                                                                                            child: Scaffold(
                                                                                              ...
                                                                                              body: Form(
                                                                                                child: Column(
                                                                                                  children: [
                                                                                                    Text("Please Edit Task", style: TextStyle(color: Colors.black54, fontWeight: FontWeight.bold)),
                                                                                                    SizedBox(
                                                                                                      height: h * 0.01,
                                                                                                    ),
                                                                                                    Container(
